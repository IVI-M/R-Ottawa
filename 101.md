...
This page provides information related  Lunch and Learn  "R-101" meet-up sessions organized by Dmitry Gorodnichy with his colleagues in Gov't of Canada. In interactive hands-on way Dmitry shows how to build from scratch Data Science Apps, such as [iTrack Covid](https://itrack.shinyapps.io/covid), using  R. 
...
For all questions please contact: [Dmitry Gorodnichy](emailto:dmitry.gorodnichy @ cbsa-asfc.gc.ca).
...
# Season 2 (Winter 20201): Developing PSES App

Tentative starting date -  Friday 9 January 2021. 
We will show you how to use Data Science using R to gain insights from the [Public Service Employee Survey (PSES)](https://www.canada.ca/en/treasury-board-secretariat/services/innovation/public-service-employee-survey.html) results - similar to how this is done [here](https://itrack.shinyapps.io/PSES/). 
...
(Note, the term "Data Science" was introduced only recently - in the last decade, where as the term *Computing Science*  --- or "Informatics" the way it is called in non-English speaking countries, or Cybernetics, or Neuro-cybernetics - the way it is also called in Germany or East Europe -  existed for over half a century.)

This defined a critical difference in the way Dmitry approaches and teaches "Data Science". It is Computer Science driven. What does it mean? Join the training to find out!



# Season 1 (Summer 2020)

Topic "R-101: Building COVID Web App from scratch"    
...
- Wrapping up our course: CMPUT 101 approach to R101 - modular, naming conventions, ToC, think algorithm/strategy (not Data) first
