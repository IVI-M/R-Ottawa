...
- Invitation to our community to contribute to https://github.com/gorodnichy/iTrack-covid and https://github.com/IVI-M/R-Ottawa/
  - Introduction to `GitHub` and `Git` within RStudio
  
- Extend Covid App to include detailed Ontario and Ottawa (Ward level) data, using data listed in https://itrack.shinyapps.io/covid/#section-info
...
- Overview of other great packages: `tidyverse`  - `dplyr` and `dtplyr`, `stingr`,  `tidymodels` 
 
- Debugging  .R and .Rmd: basic and advanced
...
### Session 8, Wed  2020/06/03 - [video](https://youtu.be/r57OZB5s-B8) 

[code]() - https://github.com/IVI-M/R-Ottawa/blob/master/r101/01-board-App-session008.Rmd
[live App](https://itrack.shinyapps.io/covid/session008.Rmd) - https://itrack.shinyapps.io/covid/session008.Rmd
