...
A better name for this course should be [CMPUT 101 - Introduction to Computing](https://www.ualberta.ca/computing-science/undergraduate-studies/course-directory/courses/introduction-to-computing.html),  which is the name course that Dmitry taught at University of Alberta (back in 1999, it was Matlab that we used back then), rather than R101.
