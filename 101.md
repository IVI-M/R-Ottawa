...
If you missed a session, you can watch it on **YouTube**: ["Lunch and Learn R - together](https://www.youtube.com/playlist?list=PLUogPW3t8g0RFvDGyKo1murnQUaSJxEPl) to catch up.
...
- General discussion: Computing Science vs. Data Science, Machine Learning vs. AI, Learning strateggies (by yourself), Community, Resources, ideas for other contributions to Ottawa/Canada (inc. for democracy and electoral reform)
...
- Ideas for homework in [Resources](resources.md)
...
- Invitation to our community to contribute to https://github.com/gorodnichy/iTrack-covid and https://github.com/IVI-M/R-Ottawa/
  - Introduction to source control and collaborative coding with `GitHub` and `Git` within RStudio
  
- Extend Covid App to to include detailed Ontario and Ottawa (Ward level) data, using data listed in https://itrack.shinyapps.io/covid/#section-info
  
- Extend Covid App  to include predictive models for Covid spread
  - Introduction to Machine Learning: basic (using built-in functions)  and advanced (using `caret` with `recipes`, `tensorflow` with `keras`)

- Add interactivity to our Covid App using `shiny`

- Overview of other `tidyverse` packages: `dplyr` and `dtplyr`, `stingr`,  `tidymodels` 

--- 

### Session 8, Fri: 2020/05/29 had to be cancelled -> moved to Wed  2020/06/03

- Debugging your .R and .Rmd: basic and advanced
  - https://adv-r.hadley.nz/debugging.html
  - https://github.com/ropenscilabs/testrmd
  
- Options for hosting (deploying) your generated report or App (hmtl, Rmd),  with and without interaction
  - github.io (example: https://ramikrispin.github.io/coronavirus_dashboard/#about)
