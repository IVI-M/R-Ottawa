...
This page provides information related  "Lunch and Learn R" seminars organized by Dmitry Gorodnichy with his colleagues in Gov't of Canada. In interactive hands-on way, they show how to learn and master R - one of the most popular tools used for data analysis and visualization -  using open source resources. 
...
Topic:  "Getting insights from PSES results: Data Science way"      (Tentative - ideas for other problems welcome! )
Sub-topic: "Foundations of robust and scalable data programming"

<!-- Practical problem topic and educational problem topic 
Dates: TBD (Tentatively, starting in April)
<!-- 
March - May    (after the [GC Data Conference 2021](https://www.csps-efpc.gc.ca/events/data-conference2021/index-eng.aspx))
...
<!-- We will build codes to generate  insights and recommendations  for any GC department or agency based on its PSES results 
...
To register, please contact  [Dmitry Gorodnichy](index.html).
