...
Sub-topic: "Foundations for robust scalable data science coding"

Tentative starting date: Friday 9 January 2021. 

Summary:   

We will learn how to use Data Science in R to gain insights from the [Public Service Employee Survey (PSES)](https://www.canada.ca/en/treasury-board-secretariat/services/innovation/public-service-employee-survey.html) results - similar to how this is done [here](https://itrack.shinyapps.io/PSES/). 
In doing that, 
we'll touch upon the record linking problem - one of the most common problems in Data Science, which happens when the same record is spelled differently in different data-sets, 
as well as upon algorithms and computer programming -
...
(Note, the term "Data Science" was introduced only recently - in the last decade, where as the term *Computing Science*  --- or "Informatics", the way it is called in non-English speaking countries, also
[Cybernetics](http://incyb.kiev.ua/?lang=en), the way it is also called in Europe --- 
<!-- [Cybernetics](http://incyb.kiev.ua/?lang=en), or Neuro-cybernetics - the way it is also called in Germany or East Europe - -->
